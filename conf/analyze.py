...
def main():
    ...
    mask_file_mimosa26_3 = f'{repo_path}/geo/mask_files/mask_MIMOSA26_3.txt'
    mask_file_mimosa26_4 = f'{repo_path}/geo/mask_files/mask_MIMOSA26_4.txt'
    mask_file_mimosa26_5 = f'{repo_path}/geo/mask_files/mask_MIMOSA26_5.txt'
